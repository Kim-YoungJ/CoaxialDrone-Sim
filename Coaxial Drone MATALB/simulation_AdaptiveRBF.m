...
%% Controller Settings 
controlParam        =   ControlSettings_AdaptiveRBF();
...
for i = 1:nStep
   ...
   if (rem(counter, 5) == 0)
       ...
       % Adatpive Control  
       [u, innerCmd, deltaFM]    =   AdaptiveRBFController(xCmd(:,i), x, 1/controlHz, param, controlParam);
       counter          =   0;
   else
       counter          =   counter + 1;
   end
