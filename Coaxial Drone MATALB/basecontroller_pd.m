function [U, InnerXcmd] = basecontroller_pd(xcmd, x, dt, param, controlParam)
...
FzControl           =   (m / (cos(theta)*cos(phi))) * (K_velD * (errorVelD) + 0*Izdot) + Fz_trim;
...
NControl            =   Iz * ((K_r * errorR) + 0*Ir) + N_trim;
